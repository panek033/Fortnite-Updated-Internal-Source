...
{
	if (husisudfr::g_GameVariables->m_ShowMenu)
		return FALSE;
...
namespace husisudfr {
	...
	bool D3D11Window::InitWindow()
	{
		...
		WindowHwnd = CreateWindow(WindowClass.lpszClassName, L"SteamOverlayU64", WS_OVERLAPPEDWINDOW, 0, 0, 100, 100, NULL, NULL, WindowClass.hInstance, NULL);
		if (WindowHwnd == NULL) {
			return FALSE;
		}
#if DEBUG
